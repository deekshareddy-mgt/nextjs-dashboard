...
export async function createInvoice(prevState:State, formData:FormData) {
  const validatedFields: z.SafeParseReturnType<
    z.infer<typeof CreateInvoice>,
    z.infer<typeof CreateInvoice>
  ...
  export async function deleteInvoice(id: string) {
    ...
    try{
        ...
        if (process.env.NODE_ENV === 'development') {
            throw error;  // Throwing the error in development so it can be caught by error boundary
          }
